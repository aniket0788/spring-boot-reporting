/*********************************************************************************************************************** 
                                          PRIVATE INVESTOR'S MONTHLY PAYOFF REPORT 
***********************************************************************************************************************/
SELECT
SCM7.INVESTOR_CODE                                                              AS Pool_Name,
SCM7.THEIR_LOAN_NO                                                              AS Loan_Number,                         --AZ: CHANGE NAME TO Loan_Number
...
LEFT OUTER JOIN (SELECT RLSM.LOAN,MON_PAYOFF,PAYOFF_REFUND,LOAN_BALANCE,INT_RATE,PAYOFF_DATE,LOAN_STATUS,SERV_FEE_BAL
                       ,MIP_BAL
